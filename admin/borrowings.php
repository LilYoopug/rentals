...
$admin_active_section = 'borrowings';
$admin_active_href = 'borrowings.php';
...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .admin-js.admin-page-loading #borrowings {
  ...
  <body class="bg-neutral-950 text-neutral-100 min-h-screen">
        ...
        <div id="content-area">
          <section id="admin-page-skeleton" aria-hidden="true">
            ...
            <div class="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 space-y-4">
              <?php for ($admin_borrowings_skeleton = 0; $admin_borrowings_skeleton < 5; $admin_borrowings_skeleton++): ?>
          ...
          <!-- Content Sections -->
          <!-- Ringkasan Section -->
          <section id="borrowings" class="content-section">
            <div class="mb-8">
    ...
    <script>
      ...
      bindById('borrowings-status-filter', 'change', filterPeminjaman);
  ...
  <script>
    ...
    <script>
document.addEventListener('DOMContentLoaded', function () {
  if (typeof renderPeminjamanTable === 'function') {
    renderPeminjamanTable();
  }
