...
$admin_active_section = 'tools-stock';
$admin_active_href = 'products.php';
...
<html lang="en">
  <head>
    ...
    <title>LensCraft - Peralatan &amp; Stok</title>
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 nav-blur border-b border-neutral-800 h-16">
      <div class="flex items-center justify-between h-full px-6">
        ...
        <div class="flex items-center gap-4">
          ...
          <span class="hidden md:inline-block text-sm text-neutral-500 border-l border-neutral-800 pl-4">Peralatan &amp; Stok</span>
        </div>
    ...
    <main class="lg:ml-64 pt-16 min-h-screen">
      <div class="p-6 md:p-8">
        ...
        <div id="content-area">
          ...
          <!-- Content Sections -->
          <!-- Ringkasan Section -->
          <section id="tools-stock" class="content-section">
            <div class="mb-8">
            ...
            <div class="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 mb-6">
              <div class="flex flex-row items-center gap-4">
                ...
                <div class="min-w-0 flex-1 relative">
                  <input type="text" id="inventory-search" placeholder="Cari equipment by name or brand..." class="w-full pl-4 pr-12 py-3 bg-neutral-800 border border-neutral-700 rounded-lg text-neutral-100 placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-neutral-700 focus:border-neutral-600 transition-all" />
  ...
  <script>
    ...
    <script>
document.addEventListener('DOMContentLoaded', function () {
  if (typeof renderInventarisTable === 'function') {
    renderInventarisTable();
  }
