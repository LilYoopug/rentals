...
$admin_active_section = 'users';
$admin_active_href = 'users.php';
...
<html lang="en">
  <head>
    ...
    <title>LensCraft - Pengguna</title>
    ...
    <style>
      ...
      .admin-js.admin-page-loading #users {
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 nav-blur border-b border-neutral-800 h-16">
      <div class="flex items-center justify-between h-full px-6">
        ...
        <div class="flex items-center gap-4">
          ...
          <span class="hidden md:inline-block text-sm text-neutral-500 border-l border-neutral-800 pl-4">Pengguna</span>
        </div>
        ...
        <div id="content-area">
          <section id="admin-page-skeleton" aria-hidden="true">
            <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div class="skeleton-shell h-12 w-40 rounded-xl"></div>
            </div>
            ...
            <div class="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 space-y-4">
              <?php for ($admin_users_skeleton = 0; $admin_users_skeleton < 5; $admin_users_skeleton++): ?>
          ...
          <section id="users" class="content-section">
            <div class="mb-8">
              <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  <h1 class="text-3xl md:text-4xl font-serif text-white mb-2">Manajemen Pengguna</h1>
                  <p class="text-neutral-400">Kelola pengguna sistem, peran, dan akses mereka.</p>
                </div>
                ...
                <table class="w-full">
                  <thead class="hidden sm:table-header-group">
                    <tr class="border-b border-neutral-800 bg-neutral-800/30">
                      ...
                      <th class="px-6 py-4 text-left text-xs font-semibold text-neutral-400 uppercase tracking-wider">Last Aktif</th>
                ...
                <div class="card-hover group">
                  <div class="flex items-start justify-between gap-3 mb-3">
                    <div class="flex items-center gap-3 min-w-0 flex-1">
                      <div class="w-12 h-12 bg-neutral-800 rounded-full flex items-center justify-center border border-neutral-700 overflow-hidden flex-shrink-0">
                        ${user.avatar && !user.avatar.includes('gear-placeholder.svg')
                          ? `<img src="${escapeHtml(user.avatar)}" alt="${escapeHtml(user.name)} avatar" class="w-full h-full object-cover" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">`
                          : ''
                        }
                        <span class="text-sm font-medium text-neutral-300 ${user.avatar && !user.avatar.includes('gear-placeholder.svg') ? 'hidden' : 'flex'} w-full h-full items-center justify-center">${escapeHtml(user.name.charAt(0))}</span>
                      </div>
                      <div class="min-w-0">
  ...
  <script>
    ...
    <script>
document.addEventListener('DOMContentLoaded', function () {
  if (typeof renderPenggunaTable === 'function') {
    renderPenggunaTable();
  }
