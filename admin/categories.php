...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .admin-js.admin-page-loading #categories {
        ...
        <div id="content-area">
          <section id="admin-page-skeleton" aria-hidden="true">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <?php for ($admin_categories_skeleton = 0; $admin_categories_skeleton < 6; $admin_categories_skeleton++): ?>
                <div class="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 space-y-4">
                  ...
                  <div class="skeleton-shell h-4 w-2/3 rounded-full"></div>
                </div>
              <?php endfor; ?>
            </div>
          </section>
