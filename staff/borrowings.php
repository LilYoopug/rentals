...
// Close mobile sidebar after selection
      ...
      function renderBorrowingsTable() {
        ...
        tbody.innerHTML = pageBorrowings.map(borrowing => {
          const actionButtons = borrowing.status === 'pending'
            ? `
          ...
          const statusBadge = `<span class="badge ${getStatusBadgeClass(borrowing.status)}">${capitalizeFirst(borrowing.status)}</span>`;
          ...
          return `
                ...
                <div class="card-hover group">
                  <div class="flex items-start justify-between gap-3 mb-3">
                    <div class="flex items-center gap-3 min-w-0 flex-1">
                      ...
                      <div class="min-w-0">
                        <h4 class="text-sm font-semibold text-white truncate">${escapeHtml(borrowing.equipment)}</h4>
                        <p class="text-xs text-neutral-400">${escapeHtml(borrowing.brand || '')} • ${escapeHtml(capitalizeFirst(borrowing.category || 'equipment'))}</p>
                  ...
                  <div class="space-y-2 text-xs mb-3">
                    <div class="flex justify-between gap-3">
                      ...
                      <span class="text-neutral-200 text-right">${escapeHtml(borrowing.customer)}</span>
                    </div>
                    <div class="flex justify-between gap-3">
                    ...
                    <div class="flex justify-between gap-3">
                      ...
                      <span class="text-neutral-200 text-right">${borrowing.days} hari</span>
                    </div>
                    <div class="flex justify-between gap-3">
                      <span class="text-neutral-500">Total</span>
                      <span class="text-white font-semibold text-right">$${Number(borrowing.amount).toFixed(2)}</span>
                    </div>
                  </div>
            ...
            <tr class="hidden sm:table-row table-row-hover transition-colors">
              ...
              <td class="px-6 py-4 text-sm font-semibold text-white">$${Number(borrowing.amount).toFixed(2)}</td>
              <td class="px-6 py-4">
                ${statusBadge}
              </td>
      ...
      function renderReturnsTable() {
        ...
        tbody.innerHTML = pageReturns.map(returnItem => {
          const actionButtons = returnItem.status === 'pending'
            ? `
          ...
          const statusBadge = `<span class="badge ${getStatusBadgeClass(returnItem.status)}">${capitalizeFirst(returnItem.status)}</span>`;
                ...
                <div class="card-hover group">
                  <div class="flex items-start justify-between gap-3 mb-3">
                    <div class="flex items-center gap-3 min-w-0 flex-1">
                      ...
                      <div class="min-w-0">
                        <h4 class="text-sm font-semibold text-white truncate">${escapeHtml(returnItem.equipment)}</h4>
                        <p class="text-xs text-neutral-400">${escapeHtml(returnItem.customer)}</p>
                  ...
                  <div class="space-y-2 text-xs mb-3">
                    <div class="flex justify-between gap-3">
                      <span class="text-neutral-500">Customer</span>
                      <span class="text-neutral-200 text-right">${escapeHtml(returnItem.customer)}</span>
                    </div>
                    <div class="flex justify-between gap-3">
                    ...
                    <div class="flex justify-between gap-3">
                      ...
                      <span class="text-neutral-200 text-right">${escapeHtml(returnItem.equipment)}</span>
                    </div>
                  </div>
...
document.addEventListener('DOMContentLoaded', function () {
  if (typeof showSection === 'function') {
    showSection('approve-borrowings');
  }
  document.querySelectorAll('a.nav-item[href]').forEach(function (link) {
    const active = link.getAttribute('href') === 'borrowings.php';
