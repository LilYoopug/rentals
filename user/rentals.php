  ...
  <body class="bg-neutral-950 text-neutral-100 min-h-screen">
        ...
        <div id="tab-all" class="tab-content">
          <div class="bg-neutral-900 border border-neutral-800 rounded-2xl overflow-hidden">
            ...
            <div id="all-empty" class="hidden p-12 text-center">
              ...
              <p class="text-neutral-400 text-sm mb-6 max-w-md mx-auto">Belum ada rental di akun Anda. Jelajahi katalog untuk memilih peralatan berikutnya.</p>
        ...
        <div id="tab-active" class="tab-content hidden">
          <div class="bg-neutral-900 border border-neutral-800 rounded-2xl overflow-hidden">
            ...
            <div id="active-empty" class="hidden p-12 text-center">
              ...
              <p class="text-neutral-400 text-sm mb-6 max-w-md mx-auto">Saat ini tidak ada rental aktif.</p>
            </div>
          </div>
        </div>
        ...
        <div id="tab-pending" class="tab-content hidden">
          <div class="bg-neutral-900 border border-neutral-800 rounded-2xl overflow-hidden">
            ...
            <div id="pending-empty" class="hidden p-12 text-center">
              ...
              <p class="text-neutral-400 text-sm">Tidak ada rental yang sedang menunggu persetujuan.</p>
            </div>
          </div>
        </div>
        ...
        <div id="tab-complete" class="tab-content hidden">
          <div class="bg-neutral-900 border border-neutral-800 rounded-2xl overflow-hidden">
            ...
            <div id="complete-empty" class="hidden p-12 text-center">
              ...
              <p class="text-neutral-400 text-sm">Belum ada riwayat rental selesai atau dibatalkan.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <script>
      ...
      function renderRentals() {
        // Get rentals for current tab
        const tabRentals = getRentalsForTab(currentTab);
        ...
        const filtered = tabRentals.filter(rental => {
          // Search filter
          if (searchTerm) {
            const matchesSearch =
              rental.id.toLowerCase().includes(searchTerm) ||
        ...
        const container = document.getElementById(`${currentTab}-rentals-list`);
        ...
        if (filtered.length === 0) {
          ...
          container.innerHTML = filtered.map(rental => createRentalRow(rental)).join('');
        }
        ...
        if (currentTab === 'all') {
          countElement.textContent = rentals.length;
        } else {
